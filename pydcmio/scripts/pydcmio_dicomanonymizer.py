...
try:
    ...
    bredala.register("pydcmio.dcmanonymizer.anonymize",
                     names=["anonymize_dicomdir", "anonymize_dicomfile",
                            "anonymize_dataset"])
except:
    pass
...
python $HOME/git/pydcmio/pydcmio/scripts/pydcmio_dicomanonymizer.py \
    -v 2 \
...
if os.path.isdir(anon_dcmdir):
    if args.erase:
        ...
        raise ValueError("The output folder '{}' already exist".format(
            anon_dcmdir))
os.mkdir(anon_dcmdir)
